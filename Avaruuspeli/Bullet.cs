...
public class Bullet
{
	...
	public Bullet(Vector2 startPosition, Vector2 size, float speed, Texture2D sprite, bool rotate, Rectangle spriteSpot)
	{
		transfrom = new Transform(startPosition, speed);
		collision = new Collision(size);
		spriterenderer = new SpriteRenderer(transfrom, collision, sprite, rotate, spriteSpot);
	}
